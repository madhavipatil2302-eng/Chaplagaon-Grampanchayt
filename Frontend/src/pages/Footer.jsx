      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-4">
            <div className="h-16 w-16 overflow-hidden rounded-full bg-white flex items-center justify-center p-1">
              {/* Fallback visual for the APEX DIGITAL logo shown in design */}
              <div className="text-[#0d302b] font-black text-xl italic tracking-tighter">APEX</div>
            </div>
            <div>
              <h3 className="font-black text-xl leading-tight">Chapalgaon<br/>GP</h3>
            </div>
          </div>
          ...
          <div className="mt-5 flex gap-3">
            {/* Facebook */}
            <a href="#" className="grid h-10 w-10 place-items-center rounded-full bg-white/10 text-white transition hover:bg-emerald-600">
