...
import { BASE_URL, buildApiUrl } from "../Services/apiConfig";
...
function EmergencyContact() {
    ...
    useEffect(() => {
        const fetchOfficialContacts = async () => {
            try {
                const response = await fetch(buildApiUrl('/official-emergency-contacts'));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(buildApiUrl('/emergency-contact'), {
                method: "POST",
                body: submitData,
            });
